...
class WeeklyReportScreen extends StatefulWidget {
  @override
  WeeklyReportScreenState createState() => WeeklyReportScreenState();
}

class WeeklyReportScreenState extends State<WeeklyReportScreen> implements OnChartValueSelectedListener {
  int type = 0;
  ...
  static TypeFace REGULAR = TypeFace(fontFamily: "OpenSans", fontWeight: FontWeight.w400);

  // ignore: non_constant_identifier_names
  static TypeFace LIGHT = TypeFace(fontFamily: "OpenSans", fontWeight: FontWeight.w300,);

  // ignore: non_constant_identifier_names
  static TypeFace BOLD = TypeFace(fontFamily: "OpenSans", fontWeight: FontWeight.w700);


  // ignore: non_constant_identifier_names
  static TypeFace EXTRA_BOLD = TypeFace(fontFamily: "OpenSans", fontWeight: FontWeight.w800);
  ...
  void initState() {
    ...
    firstDay = now.subtract(Duration(days: currentDay));
    lastDay = now.add(Duration(days: (DateTime.daysPerWeek - currentDay)-1));
    lastDate = now.add(Duration(days: (DateTime.daysPerWeek - currentDay)-1));
  ...
  loadWeekList(){
    lst_week.clear();
    lst_week.add(buildTranslate(context,"sun"));
    lst_week.add(buildTranslate(context,"mon"));
    lst_week.add(buildTranslate(context,"tue"));
    lst_week.add(buildTranslate(context,"wed"));
    lst_week.add(buildTranslate(context,"thu"));
    lst_week.add(buildTranslate(context,"fri"));
    lst_week.add(buildTranslate(context,"sat"));
  }
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                setState(() {
                  ...
                  lastDay = lastDay.subtract(Duration(days: 7));
                });
            ...
            InkWell(
              onTap: () {
                ...
                DateTime tmpFirstDay = firstDay.add(Duration(days: 7));
...
class MyDayFormat extends ValueFormatter{
  ...
  String getFormattedValue1(double value) {
    try {
      ...
      if (lst_week.length > index)
        return lst_week[index];
    }
    catch (e){}
    return "N/A";
  }
